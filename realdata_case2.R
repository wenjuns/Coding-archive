...
library(MESS)
#=============================================================== read data
data_all=read.csv("/Users/shenwenjun/Desktop/materials/preparation/code/CommViolPredUnnormalizedData.txt",header = FALSE)
...
#=============================================================== Define variables
data_y=data_all[,131]
data_Exogenous=data_all[,c(18,26,27,35:37,43:47,93,121:123)]
data_Instruments=data_all[,c(7:17,19:24,28:30,32,38:42,48:84,88,92,94:103)]
data_Endogenous=data_all[,34]
K1 = 10            
t1 = 10
K1_plus = 10
t1_plus = 10
...
Xo=apply(data_Exogenous,2,fn_scale)
Xo=as.matrix(Xo)
XI=apply(data_Instruments,2,fn_scale)
Xe=data_Endogenous
...
dim(XI)
corXIXe = t(cor(Xe, XI))
plot(1:75,corXIXe[1:75,],xlab="Index of Potential Instruments", ylab="Correlation with Xe", main=expression(paste("Correlation between Xe and Potential Instruments in Dataset")),  pch=18, col="blue", xlim=c(1,80), ylim=c(-1,1))
axis(1, at = c(10,20,30,40,50,60,70,80), labels = c(10,20,30,40,50,60,70,80))
rug(x = c(0, 10,20,30,40,50,60,70,80)+ 5, ticksize = -0.01, side = 1)
colnames(XI)[which(abs(cor(XI,Xe))>0.7)]
###
a = as.numeric(cor(Xe,XI))
a=abs(a)

##subsetting the exogenous variables
length(which(abs(cor(Xe, XI))<0.2))
md1=lm(Y~Xo+Xe+0)
...
fn_big=function(y, xe, xI, xo, n,t,K)
{
  ...
  #============================ Method 4: pLasso
  lasso_M6 = fn_lasso(y, xe, xI, xo, n, 1)
  S6 = lasso_M6[,1]
  fstat6 = lasso_M6[,2]
  dfR6 = lasso_M6[,3]
  dfE6 = lasso_M6[,4]
  ...
  #============================ Method 5: pEL_0.5
  lasso_M7 = fn_lasso(y, xe, xI, xo, n, 0.5)
  S7 = lasso_M7[,1]
  fstat7 = lasso_M7[,2]
  dfR7 = lasso_M7[,3]
  dfE7 = lasso_M7[,4]
  ...
  #============================ Method 6: pEL_{1/3}
  lasso_M8 = fn_lasso(y, xe, xI, xo, n, 0.33333333)
  S8 = lasso_M8[,1]
  fstat8 = lasso_M8[,2]
  dfR8 = lasso_M8[,3]
  dfE8 = lasso_M8[,4]
...
for(t in 5:15){
  for(K in 5:15){
    ...
    if((result_full[1,8]>result_full[3,8])&((result_full[2,8]>result_full[4,8]))){
      print(t)
      print(K)
      print(result_7[1,1])
      print(result_7[2,1])
